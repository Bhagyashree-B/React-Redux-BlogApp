...
- [Running Tests](#running-tests)
  ...
  - [Coverage Reporting](#postContentage-reporting)
...
Jest has an integrated postContentage reporter that works well with ES6 and requires no configuration.<br>
Run `npm test -- --postContentage` (note extra `--` in the middle) to include a postContentage report like this:

![postContentage report](http://i.imgur.com/5bFhnTS.png)

Note that tests run much slower with postContentage so it is recommended to run it separately from your normal workflow.
